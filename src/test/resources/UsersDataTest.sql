insert into users(mail,password,account_balance,date_creation)values("me@paymybuddy.com", "$2a$10$FzNJQrIguYNMPrsbj6u29.tAiZWj5QdPcDrxPMP1A/rSxLkPRWyvi",170,NOW());
...
insert into users(mail,password,account_balance,date_creation,firstname,lastname)values("profile@paymybuddy.com", "$2a$10$39nOUuqYo/M.PYXUN1UUHuyTJ23yTDDX2zNdXFSbkoAkFzm4/jSnq",80,NOW(),"Adrien","Vier");
